			...
			try {
				...
				case 1:
					...
					if (!novaTarefa.trim().isEmpty()) {
						...
						JOptionPane.showInternalMessageDialog(null, "Por favor digite uma tarefa valida ");
					}
				...
				case 2:
					if (listaDeTarefas.isEmpty()) {
						JOptionPane.showMessageDialog(null, "A lista de tarefas esta vazia.");
						...
						int indiceTarefa = Integer.parseInt(JOptionPane
								.showInputDialog(tarefas.toString() + "Digite o numero da tarefa a ser removida"));

						if (indiceTarefa >= 1 && indiceTarefa <= listaDeTarefas.size()) {
							listaDeTarefas.remove(indiceTarefa - 1);
							JOptionPane.showMessageDialog(null, "Tarefa " + listaDeTarefas + " removida com sucesso!");
						} else {
							JOptionPane.showMessageDialog(null, "Numero da tarefa invalido");
						}
